      ...
      <div className="w-full max-w-md">
        ...
        <div className="card-professional">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-primary mb-2">Vendor Login</h1>
            <p className="text-slate-600">Access your vendor dashboard</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            {/* Vendor ID */}
            <div>
              <label className="block text-sm font-semibold text-slate-900 mb-2">Vendor ID</label>
              <input
                type="text"
                ...
                disabled={loading}
                className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent transition bg-white"
              />
            </div>
          ...
          <Link href="/vendor-register">
            <Button variant="outline" className="w-full border-2 border-secondary text-secondary hover:bg-secondary hover:text-white py-3 text-lg transition-all">
        ...
        <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg text-center">
          <p className="text-sm text-blue-900">
            <span className="font-semibold">Demo Credentials:</span> vendor_catering / vendor123
          </p>
        </div>
      </div>
    </main>
